...
struct PLAYER_NAME : public Player {
    ...
    bool pos_valida (const Pos& pos, const Dir& d, int dist) { //comporvamos que no haya pneumatico ni cohce yq ue este dentro del rango //mirar tambien lo de los misiles
        ...
        else return true;//falta mirar lo de los posiciones
    }
